...
import EVNOneItem from './OneLevelItem';

class EVNTwoLevelItem extends Component {
  constructor(props) {
    super(props);
...
const Dump = ({ ...props }) => (
  <EVNTwoLevelItem {...props} className={props.className} />
);

export default connect()(EVNTwoLevelItem);
