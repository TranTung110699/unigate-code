...
class ExerciseExamItem extends React.Component {
  ...
  renderHeaderForWeb = (name, timeLeft, userName) => (
    <div className="container exam-exercise-for-web">
      <div className="row">
        ...
        <div className={`col-sm-3 ${this.cssClass}__duration`}>
    ...
    return (
      <div className={this.cssClass}>
        <div className={`${this.cssClass}__header`}>
          {this.renderHeaderForWeb(name, timeLeft, userName)}
...
const mapStateToProps = (state, props) => {
  ...
  let currentListeningQuestionUniqueId = null;
  ...
  if (!exercises) {
    ...
    const { introStickyUniqueId, itemUniqueIds } = navigationInfo;
    ...
    const listeningNavigationInfo =
      getListeningNavigateInfoOfExerciseSelector(state)(learnItemIid) || {};
    if (listeningNavigationInfo.isCurrentQuestionActive) {
      currentListeningQuestionUniqueId =
        listeningNavigationInfo.currentQuestionUniqueId;
      [
        currentListeningQuestion,
