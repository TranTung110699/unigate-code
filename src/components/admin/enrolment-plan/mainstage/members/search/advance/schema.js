...
const getElementsSchema = (forRecap = false, props) => (
  ...
  let elementsSchema = {
    ...
    //   type: 'select',
    //   floatingLabelText: t1('survey_response_status'),
    ...
    //     {
    //       value: 'completed',
    //       label: t1('completed_the_survey'),
    //     },
    //     {
    //       value: 'not_yet_completed',
    //       label: t1('not_yet_completed_the_survey'),
    //     },
    //   ],
    // },
  };
...
const ui = (step, values, themeConfig, xpath, formid) => {
  ...
  if (availFilters && !!values.training_plan_iid) {
    fields.push('enrolment_plan_iids');
    // fields.push('survey_response_status');
    allowedEnabledFilters.push('enrolment_plan_iids');
    // allowedEnabledFilters.push('survey_response_status');
  }
