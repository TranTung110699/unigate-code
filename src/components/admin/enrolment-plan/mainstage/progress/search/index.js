...
import schema from 'components/admin/enrolment-plan/mainstage/progress/schema/schema';
  ...
  render() {
    ...
    return (
      <SearchWrapper
        formid={formid}
        schema={schema}
        alternativeApi={apiUrls.enrolment_plan_progress}
