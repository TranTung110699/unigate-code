...
class ImportForm extends Component {
  ...
  handleClick = () => {
    ...
    const urlNew = apiUrls.new_organizations_import;
  ...
  handleDownloadTemplate = () => {
    ...
    const url = apiUrls.get_import_organization_file_template;
              ...
              {importDataStatus &&
                ...
                importMetadata.import_id && (
                  <SearchWrapper
                    ...
                    alternativeApi={apiUrls.organizations_import_search}
