    ...
    return (
      <div className="container-fluid elementGroup">
        ...
        <div className="row">
          ...
          <div className="col-md-3 element-item">
            {groups.id.fieldNames.position_id_operator}
          </div>
          <div className="col-md-3 element-item">
            {groups.id.fieldNames.TEN_VTRICDANH}
          </div>
          <div className="col-md-3 element-item">
            ...
            {Perm.hasPerm('root') && (
              <ResyncDataFromShareDBBtn
                ...
                resyncDataFromShareDBUrl={
                  hrmsEvnApiUrls.update_elearning_updated_at_to_evn_hrms_positions
                }
                searchFormId={'hrms_position_search'}
                textConfirm={t1(
                  'do_you_want_update_elearning_updated_at_to_evn_hrms_positions?',
                )}
              />
            )}
          </div>
