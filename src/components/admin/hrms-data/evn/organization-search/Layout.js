...
class Layout extends Component {
  ...
  renderResultComponent(items, props) {
    const renderResults = (showEditAccountButton) => (
      <Results
        ...
        form="hrms_organization_search_result"
  ...
  render() {
    return (
      <div>
        <SearchWrapper
          formid={'hrms_organization_search'}
          schema={schema()}
          renderResultsComponent={this.renderResultComponent}
          showSearchButton
          alternativeApi={hrmsEvnApiUrls.hrms_organization_search}
          searchResultKey={`hrms_organization_search`}
        />
      </div>
    );
  }
