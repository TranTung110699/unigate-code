...
class Layout extends Component {
  ...
  renderResultComponent(items, props) {
    const renderResults = (showEditAccountButton) => (
      <Results
        ...
        form="hrms_equivalent_position_search_result"
  ...
  render() {
    return (
      <div>
        <SearchWrapper
          formid={'hrms_equivalent_position_search'}
          schema={schema()}
          renderResultsComponent={this.renderResultComponent}
          showSearchButton
          alternativeApi={hrmsEvnApiUrls.hrms_equivalent_position_search}
          searchResultKey={`hrms_equivalent_position_search`}
        />
      </div>
    );
  }
