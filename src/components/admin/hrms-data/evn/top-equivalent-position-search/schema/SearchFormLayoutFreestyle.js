    ...
    return (
      <div className="container-fluid elementGroup">
        ...
        <div className="row">
          ...
          <div className="col-md-3 element-item">
            {groups.id.fieldNames.CDANHTDUONG_EVN_CODE}
          </div>
          <div className="col-md-3 element-item">
            {groups.id.fieldNames.top_equivalent_position_code_operator}
          </div>
        </div>
        <div className="row">
          <div className="col-md-3 element-item">
            {groups.id.fieldNames.CDANHTDUONG_EVN}
          </div>
          <div className="col-md-3 element-item">
            {groups.id.fieldNames.top_equivalent_position_name_operator}
          </div>
        </div>
        <div className="row">
            ...
            {Perm.hasPerm('root') && (
              <ResyncDataFromShareDBBtn
                ...
                resyncDataFromShareDBUrl={
                  hrmsEvnApiUrls.update_elearning_updated_at_to_evn_hrms_top_equivalent_positions
                }
                searchFormId={'hrms_top_equivalent_position_search'}
                textConfirm={t1(
                  'do_you_want_update_elearning_updated_at_to_evn_hrms_top_equivalent_positions?',
                )}
              />
            )}
          </div>
