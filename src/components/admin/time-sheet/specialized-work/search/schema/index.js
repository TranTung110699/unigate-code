import {
  SpecializedWorkTimeSheetSearchFormCurrentContractInfoSectionLayout,
  SpecializedWorkTimeSheetSearchFormLayout,
} from './layouts';
...
const specializedWorkTimeSheetSearchSchema = {
  schema: (formid, values) => ({
    ...
    current_contract_info: {
      ...
      schema: {
        ...
        layout: {
          component: SpecializedWorkTimeSheetSearchFormCurrentContractInfoSectionLayout,
          freestyle: 1,
        },
      },
    },
  ...
  layout: {
    component: SpecializedWorkTimeSheetSearchFormLayout,
    freestyle: 1,
  },
};

export default specializedWorkTimeSheetSearchSchema;
