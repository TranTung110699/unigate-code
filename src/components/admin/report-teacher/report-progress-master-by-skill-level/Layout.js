...
import schema from '../report-progress-master-by-academic-categorie/schema-form';
import { menuItems } from '../menu/sub-left-menu-configs';
import get from 'lodash.get';

const formid = 'progress_master_by_skill_level';
  ...
  render() {
    return (
      <div>
        ...
        <Card title={t2('report_progress_master_by_skill_level')}>
          <SearchWrapper
            showResult
            formid={formid}
            schema={schema}
            ...
            alternativeApi={apiUrls.get_progress_master_by_skill_level}
          />
        </Card>
      </div>
    );
