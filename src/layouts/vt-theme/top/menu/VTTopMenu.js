...
class VTTopMEnu extends Component {
  constructor(props) {
    super(props);
  ...
  onShowLoginPopup = () => {
    ...
    dispatch(openLoginDialog(getOptionsPropertiesLogin(layouts.VT)));
  };
  ...
  render() {
    ...
    return (
      <div style={style.customWidth}>
        <div className="vt-header-menu-top">
...
export default connect(mapStateToProps)(VTTopMEnu);
