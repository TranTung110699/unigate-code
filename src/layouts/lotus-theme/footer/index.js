    ...
    return (
      <div className="lotus-footer">
        <div className="container">
          <div className="row">
            <div className="lotus-footer__group col-md-4">
              <div className="lotus-footer__contact">
                <div className="lotus-footer__contact-title">
                  {t3('head_office')}
                </div>
                <div className="lotus-footer__contact-details">
                  <div className="lotus-footer__contact-detail">
            ...
            <div className="lotus-footer__group col-md-4">
              <div className="lotus-footer__logo">
                <img src={themeConfig.footer_logo} alt="VietEd" />
                <p>{copyright}</p>
              </div>
              <div className="lotus-footer__social">
                <Link to="#">
              ...
              <SettingLanguage className="lotus-footer__language" />
            </div>
          </div>
        </div>
      </div>
